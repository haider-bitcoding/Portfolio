...
const projects = [
  {
    ...
    metrics: "reduced auth latency",
    description:
      "Full-stack academic productivity platform with a self-linking workspace graph, a proactive AI agent that sends scheduled nudges, and an XP/gamification layer — built on a custom design system with dark mode.",
    tags: [
      "Spring Boot",
      "Java 17",
      "PostgreSQL",
  ...
  },
  {
    ...
    metrics:
      "Handled 3500+ employee records, automated bulk import/export reducing processing time by 70%",
    description:
      "A private full-stack management system built for TEVTA to handle employee insurance records at scale —  bulk import/export, secure auth, and centralized data storage.",
    tags: [
      "React.js",
      "Node.js",
      "MongoDB",
  ...
  },
  {
    ...
    metrics:
      "Showcased 20+ publications, 15 teaching courses, and awards archive",
    description:
      "Responsive portfolio site for a university professor, showcasing research output, publications, teaching activity, and awards.",
    tags: ["Next.js", "HTML5", "CSS3"],
  ...
  },
  {
    ...
    metrics:
      "Showcased 15+ research projects across AI, computer vision, and blockchain domains",
    description:
      "Site built for a university research lab working on multimodal AI, computer vision, LLMs, trustworthy AI, cybersecurity, and blockchain research.",
  ...
  },
  {
    ...
    description:
      "Mobile-first restaurant ordering mini program for WeChat — browse menus and place orders without leaving the chat app.",
        ...
        >
          <header className="mb-10">
            ...
            <p className="text-text-muted max-w-xl">
              Production projects I've built — from SaaS platforms to client
              websites.
            </p>
          </header>
